...
struct GroundTrackService {
    ...
    func fetchGroundTrack(inputType: InputOptions, searchItem: String, start: Date, end: Date, step: String) async throws -> [String: GroundTrackPoint] {
        ...
        case InputOptions.tle:
            ...
            // Request
            var request = URLRequest(url: URL(string: "http://\(chosenIP):8080/groundtrack/tle")!)
        ...
        case InputOptions.name:
            ...
            // Request
            var request = URLRequest(url: URL(string: "http://\(chosenIP):8080/groundtrack/name")!)
            request.httpMethod = "POST"
            request.setValue("application/json", forHTTPHeaderField: "Content-Type")
        ...
        case InputOptions.norad:
            ...
            var request = URLRequest(url: URL(string: "http://\(chosenIP):8080/groundtrack/norad")!)
            request.httpMethod = "POST"
            request.setValue("application/json", forHTTPHeaderField: "Content-Type")
